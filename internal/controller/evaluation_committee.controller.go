...
// @Accept json
// @Produce json
// @Param evaluation_committee_id path int true "evaluation_committee_id"
...
// @Security ApiKeyAuth
func (ecc *EvaluationCommitteeController) GetListTeachersHaveEvaluationCommiteeGroup(ctx *gin.Context) {
